<template>
    <v-layout align-start>
        <v-flex>
            <v-toolbar text color="green accent-1">
                <v-toolbar-title>Herramienta Bogotá</v-toolbar-title>
                <v-divider
                class="mx-2"
                inset
                vertical
                ...
                <v-dialog v-model="adModal" max-width="290">
                    <v-card>
                        ...
                        <v-card-text>
                            Estás a punto de <span v-if="adAccion==1">enviar a Tena </span>
                            <span v-if="adAccion==2">enviar a Tena </span> el item {{adNombre}}
                        </v-card-text>
                        <v-card-actions>
                            <v-spacer></v-spacer>
            ...
            <template v-slot:[`item.estado`]="{ item }">
                 <div v-if="item.estado">
                        <span class="blue--text">Bogota</span>
                    </div>
                    <div v-else>
                        <span class="red--text">Tena</span>
                    </div>
            </template>
                <template v-slot:no-data>
                <v-btn color="primary" @click="listar()">Buscando Articulos</v-btn>
                </template>
            </v-data-table>
        </v-flex>
    </v-layout>
    ...
    export default {
            ...
            return{
                ...
                headers: [
                    ...
                    { text: 'Estado', value: 'estado', sortable: true },
                     { text: 'Movimiento', value: 'opciones', sortable: false },
                ],
                id:'',
                editedIndex: -1,
                categoria:'',
        ...
        methods: {
            listar(){
                ...
                axios.get('articulo/listBta',configuracion).then(function (response){
