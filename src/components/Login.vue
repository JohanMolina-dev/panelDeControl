    ...
    <v-layout align-center justify-center>
        <v-flex xs12 sm8 md6 lg5 x14>
            <v-card>
                ...
                <v-card-text>
                    <v-text-field v-model="email" autofocus color="teal accent-3" label="Email" required>
                    </v-text-field>
                    <v-text-field v-model="password" type="password" color="teal accent-3" label="Contraseña" required>
                    </v-text-field>
                ...
                <v-card-actions class="px-3 pb-3">
                    <v-flex text-xs-right>
                        <v-btn block @click="ingresar()" color="teal accent-3">Ingresar</v-btn>
                    </v-flex>
                </v-card-actions>
            </v-card>
        </v-flex>
