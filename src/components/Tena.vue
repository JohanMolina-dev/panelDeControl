    ...
    <v-layout align-start>
        <v-flex>
            <v-toolbar text color="green accent-1">
                <v-toolbar-title>Herramienta Tena</v-toolbar-title>
                <v-divider
                class="mx-2"
                inset
                vertical
                ...
                <v-dialog v-model="adModal" max-width="290">
                    <v-card>
                        ...
                        <v-card-text>
                            Estás a punto de <span v-if="adAccion==1">enviar a Bogotá </span>
    ...
    export default {
        ...
        methods: {
            listar(){
                ...
                axios.get('articulo/listTena',configuracion).then(function (response){
